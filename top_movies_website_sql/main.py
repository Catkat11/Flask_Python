...
# URLs and API key for The Movie Database (TMDB)
MOVIE_DB_SEARCH_URL = "https://api.themoviedb.org/3/search/movie"
MOVIE_DB_INFO_URL = "https://api.themoviedb.org/3/movie"
MOVIE_DB_IMAGE_URL = "https://image.tmdb.org/t/p/w500"
MOVIE_DB_API_KEY = '19b4c11153f38fc34e623f80f1b623b0'
...
# Define the Movie table structure
...
# Define the form for rating movies
class RateMovieForm(FlaskForm):
    rating = StringField("Your Rating Out of 10")
    review = StringField("Your review")
    submit = SubmitField("Done")

# Define the form for finding movies
...
def home():
    ...
    # Calculate the ranking based on the ordering
...
# Route for finding movie details
@app.route('/find')
def find_movie():
